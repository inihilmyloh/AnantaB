...
//        setupPanelUtama();
    ...
    private void field_cari_DPengeluaranKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_field_cari_DPengeluaranKeyTyped
        ...
        try {
            ...
            Logger.getLogger(FormPengeluaran.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void aturEditFieldTotalHarga() {
        boolean restock = "Restock Barang".equals(cbbx_pilihKategori.getSelectedItem());
        fieldTotalHarga.setEditable(!restock);
        if (restock) {
    ...
    private void FPengeluaranDefault() {
        ...
        boolean TotalKosong = total.isEmpty() || total.equals("0");
        boolean KategoriDefault = kategori.equals("Pilih Jenis Pengeluaran");
    ...
    private void aturTampilanDaftarDetail(boolean tampil) {
        ...
        int tinggiScroll = tampil ? 400 : 860;
